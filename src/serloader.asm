...
1       jsr     [polcat]        ; Abort on keypress
        bne     bye
        jsr     readhdr
        bne     1b              ; Silently retry to handle timeout
...
abort   ldx     #err            ; Tell remote host to abort transfer
        ldy     #1
        jsr     DWWrite
        ldx     #failmsg        ; Return FAIL unless this was a tape error
        lda     csrerr
        beq     1f
        ldx     #taperr
1       jsr     prstr
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Reads a 1KB chunk from the port
;
; Outputs:
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
read_kb bsr     goahead
        ldx     #buf            ; Read 1024 bytes into buf
        ldy     #1024
        jsr     DWRead          ; TODO - verify checksum
2       rts

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Writes 1KB of data from target -> ROM
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
pgmblk  nop         ; DEBUG HARNESS
        ldx         #buf
        ldy         target
        orcc       #$50   ;disable interrupts
...
hello   fcc "COCOFLASH MINI SERIAL LOADER V0.9"
